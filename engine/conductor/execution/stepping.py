...
class Stepping:
    ...
    def _advance(self, stack: Stack, wrong: str = "") -> Block | None:
        ...
        while True:
            ...
            if navigation.exhausted(frame):
                ...
                if frame.cycle:                  # an ITERATED door: its token is asked
    ...
    def _lap_payloads(self, document: Document, element: str) -> None:
        ...
        self.note(str(reading.cycles(document)), element, "served", "cycle", by=document.name)
        self._payloads.append((str(reading.cycles(document)), element))
